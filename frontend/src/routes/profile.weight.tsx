...
function WeightPage() {
  ...
  const handleLog = () => {
    ...
    setHistory((prev) => [{ date: todayDateStr, weight: num }, ...prev]);
    setTodayWeight("");
  };
    ...
    <AppShell>
      ...
      <div className="px-4 lg:px-8 py-6 max-w-2xl mx-auto space-y-6">
        ...
        <div className="text-center mb-6">
          <div
            className="mx-auto w-12 h-12 rounded-full grid place-items-center mb-3"
        ...
        <div className="card-frosted p-5">
          ...
          <div className="space-y-4">
            {exerciseLoadHistory.map((exHistory) => {
              ...
              const displayWeight = isSameUnit
                ? latest.weight
                : convertWeight(latest.weight, exHistory.unit, unit);
